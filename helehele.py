...
class helehele(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "helehele")
        ...
        self.freq = freq = 100000

        ##################################################
        # Blocks
        ##################################################
        self._freq_range = Range(1, 15000000, 1000, 100000, 200)
...
def main(top_block_cls=helehele, options=None):
